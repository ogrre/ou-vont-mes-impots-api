...
API publique et en lecture seule du projet éducatif « Mais où vont mes impôts ? ».

Les montants sont exprimés en euros et conservent leur contexte comptable ainsi que leur provenance. Les données du MVP portent uniquement sur le budget de l’État français : elles ne représentent pas l’ensemble des dépenses publiques françaises.

Aucune authentification n’est requise. Merci de citer la source et les métadonnées de provenance fournies avec chaque réponse.
MARKDOWN,
    ],

    'ui' => [
        'title' => 'Mais où vont mes impôts ? — Documentation de l’API',
    ],
